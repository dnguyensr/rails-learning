...
class VouchersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voucher" do
    assert_difference('Voucher.count') do
      post vouchers_url, params: { voucher: { event: @voucher.event, owner_id: @voucher.owner_id } }
    end
  ...
  test "should update voucher" do
    patch voucher_url(@voucher), params: { voucher: { event: @voucher.event, owner_id: @voucher.owner_id } }
